    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="glass p-6 sm:p-10 rounded-3xl border border-white/5 bg-zinc-900/10 space-y-8 text-sm sm:text-base text-zinc-300 leading-relaxed">
        <section className="space-y-3">
          <h2 className="font-heading text-xl font-bold text-zinc-100">1. Acceptance of Terms</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-heading text-xl font-bold text-zinc-100">2. Account Registration & Verification</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-heading text-xl font-bold text-zinc-100">3. Submission Guidelines & Location Accuracy</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-heading text-xl font-bold text-zinc-100">4. Vetting & Moderation</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-heading text-xl font-bold text-zinc-100">5. Content License</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-heading text-xl font-bold text-zinc-100">6. Travel Advisories & Disclaimer of Liability</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-heading text-xl font-bold text-zinc-100">7. Limitation of Liability</h2>
          <p>
